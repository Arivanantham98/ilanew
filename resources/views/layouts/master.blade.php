        ...
        {{-- <div class="login-popup">
            <div class="box">
                <div class="img-area">
                    ...
                    <img src="{{ asset('./images/logo/ila_logo.png') }}"
        alt="">
    </div>
    <div class="form">
        ...
        <div class="containers">
            <div class="wrapper">
                <div class="header-item-left">
                    ...
                    <a href="{{ url('/') }}"> <img src="{{ asset('./images/logo/new_logo.png') }}" alt="" width='50%'></a>
                </div>
                <!-- Section: Navbar Menu -->
                <div class="header-item-center">
                    ...
                    <nav class="menu">
                        <div class="menu-mobile-header">
                            <button style="border: 0px;border-radius: 0px;padding-top:0;padding-bottom:0;" type="button" class="menu-mobile-arrow"><i class="ion ion-ios-arrow-back"></i></button>
                            <div class="menu-mobile-title"></div>
                            <button style="border: 0px;border-radius: 0px;padding-top:0;padding-bottom:0;" type="button" class="menu-mobile-close"><i class="ion ion-ios-close"></i></button>
                        </div>
                        <ul class="menu-section">
                            ...
                            <li class="menu-item-has-children">
                                <a href="#">Legal Categories<i class="ion ion-ios-arrow-down"></i></a>
                                <div class="menu-subs menu-mega menu-column-5">
                                    ...
                                    <div class="list-item">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ route('perosnalfamily.labourservices') }}">Labour&Service</a></li>
                                            <li><a href="{{ route('civildebt.recovery') }}">Money Recovery</a></li>
                                    ...
                                    <div class="list-item">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ route('civildebt.consumercourt') }}">Small cause cases(consumer issues)</a></li>
                                            <li><a href="{{ route('civildebt.civil') }}">Civil</a></li>
                                            <li><a href="{{ route('civildebt.writ') }}">Writ Petition</a></li>

                                        </ul>
                                    </div>
                                    <div class="list-item">
                                        <h4 class="title">Criminal</h4>
                                        <ul>
                                            <li><a href="{{ route('criminalproperty.criminal') }}">Criminal</a></li>
                                            <li><a href="{{ route('criminalproperty.cybercrime') }}">Cyber Crime</a></li>
                                            <li><a href="{{ route('criminalproperty.pocso') }}">POCSO</a></li>

                                        </ul>

                                    </div>
                                    <div class="list-item">
                                        <h4 class="title">Property</h4>
                                        <ul>
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <div class="menu-subs menu-column-1">
                                    <ul style="list-style: none">
                                        ...
                                        <li><a href="{{ route('perosnalfamily.willstrust') }}">Wills/Trusts</a></li>
                                        <li><a href="#">Advocate Welfare</a></li>
                                        <li><a href="#">Senior Advocate Welfare Form</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="menu-item-has-children">
                ...
                <div class="header-item-right">
                    <button style="margin-right:10px;font-size:0.8rem;font-weight:400" class="tp-caption ttm-btn ttm-btn-style-fill ttm-btn-color-skincolor">Join Us</button>

                    <button style="font-size:0.8rem;font-weight:400;" class="tp-caption ttm-btn ttm-btn-style-fill ttm-btn-color-skincolor">Book an
                        appointment</button>
                                    ...
                                    <div class="site-navigation-content d-flex flex-row">
                                        <div class="site-branding mr-auto">
                                            <a class="home-link" href="index.html" title="IndolawAssociates" rel="home">
                                                <img id="logo-img" class="img-center" src="{{ asset('./images/logo/ila-logo.png') }}"
                                                    alt="logo-img">
                                            </a>
                                        </div>
