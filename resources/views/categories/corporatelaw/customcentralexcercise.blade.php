                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-title-heading">
                            <h2 class="title">Custom Central Excercise</h2>
                        </div>
                        <div class="breadcrumb-wrapper">
                            <span>
                                <a title="Homepage" href="index.html">Home</a>
                            </span>
                            <span>Custom Central Excercise</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                <h3>Custom Central Excercise</h3>
                                <div class="row mt-15 mb-30 px-4">
                                    <p>The customs and Central Excise administrate customs law in India and collection of import duties\land revenues.</p>
                                   <p>The Central Board of Excise and Customs (CBEC) is a part of the Department of Revenue under the Ministry of Finance, Government of India. It formulates policies for the levy and collection of customs and central excise duties and service tax, prevention of smuggling and administration of matters relating to customs, central excise, service tax and narcotics. The Board is the administrative authority for its subordinate organisations, including Custom Houses, Central Excise and Service Tax Commissioners and the Central Revenues Control Laboratory.</p>
                    <h5>Difference between Excise Duty and Custom Duty</h5>
                    While excise duty is <strong>levied on goods produced or manufactured within the country,</strong> custom duty applies to the goods that are sold in India but were produced in a different country. Excise duty is to be paid by the manufacturer of the goods and not by the consumer
                    <p></p>
                                </div>
