                    ...
                    <div class="col-lg-8 content-area">
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                ...
                                <div class="mb-15">
                                    <p>It is a method in legal system employed to recover the proceeds,</p>
                                    <p><strong>Ex:</strong> Civil recovery to recover the value of the property.</p>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- ttm-fid -->
