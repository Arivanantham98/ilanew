                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-title-heading">
                                <h2 class="title">Faulty Product Notice</h2>
                            </div>
                            <div class="breadcrumb-wrapper">
                                <span>
                                    <a title="Homepage" href="index.html">Home</a>
                                </span>
                                <span>Faulty Product Notice</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <aside class="widget tagcloud-widget with-title ttm-bgcolor-grey">
                                ...
                                <div class="tagcloud">
                                    ...
                                    <a href="{{ route('family.marriageregistration') }}" class="tag-cloud-link"># Marriage
                                        Registration</a>
                                    <a href="{{ route('civillaw.propertyverification') }} class="
                        ...
                        <div class="col-lg-8 content-area">
                            <div class="ttm-service-single-content-area">
                                ...
                                <div class="ttm-service-description row mt-15 px-4">
                                    <h3>Faulty product Notice</h3>
                                    <div class="mb-15">
                                        <p>The legal notice should contain the name, description, and place of
                                            residence/office of the seller of the goods/services. The legal notice should
                                            mention the date from when the issue has taken place. 
                                        </p>
                                    </div>
                                </div>
                                <div class="col-sm-12  mb-10 ">
                                    <h5>How Faulty Notice prepared ?</h5>
                                    <p>The notice should mention
                                        all the facts and grievances in details with proper dates.
                                        This notice is sent by the consumer to the seller, When the product bought by
                                        the customer is faulty or defective. The seller must replace the product.</p>
                                </div>
                                <div class="row  px-4">
                                    <h5>What is not done ?</h5>
                                </div>
                                <div class="row  mb-10 px-4">
                                    <p class="d">Except Legal notice filing of any case is not included in this service</p>
                                </div>
                                <div class="col-sm-12  mb-10 ">
                                    ...
                                    <ul
                                        ...
                                        <li><i class="fa fa-arrow-circle-right"></i>
                                            <div class="ttm-list-li-content">Provide you with the best Lawyers
                                            </div>
                                        </li>
                                        <li><i class="fa fa-arrow-circle-right"></i>
                                            <div class="ttm-list-li-content">Assistance in drafting
                                            </div>
                                        </li>
                                        <li><i class="fa fa-arrow-circle-right"></i>
                                            <div class="ttm-list-li-content">Day to day reporting

                                            </div>
                                        </li>
                                        <li><i class="fa fa-arrow-circle-right"></i>
                                            <div class="ttm-list-li-content">End to End assistance
                                            </div>
                                        </li>
                                    </ul>
                                </div>
